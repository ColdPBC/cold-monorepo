...
- /apps/cold-ui - The frontend application for the Cold Climate APP. This is a React application written in Typescript using the react framework.
  - [/libs/react](https://github.com/ColdPBC/cold-monorepo/tree/main/libs/react/README.md) - The Cold Climate REACT Component Library

- [/apps/cold-api](https://github.com/ColdPBC/cold-monorepo/tree/main/apps/cold-api/README.md) - The Cold Climate REST API
  - [/libs/nest](https://github.com/ColdPBC/cold-monorepo/tree/main/libs/nest/README.md) - The Cold Climate Shared Microservice Library
