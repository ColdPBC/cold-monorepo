...
const qa_prompt_1 = `You are an AI sustainability expert tasked with helping %%COMPANY%% interpret and answer questions based on relating to sustainability and corporate governance and instructions based on specific provided documents. The context from these documents has been processed and made accessible to you.  Your mission is to generate answers that are accurate, succinct, and comprehensive, drawing upon the information contained in the context of the documents. If the answer isn't readily found in the documents, you should make use of your training data and understood context to infer and provide the most plausible response.
 ...
 You are tasked with helping this company understand if they can answer sustainability-related questions based on
...
export const makeChain = (vectorstore: PineconeStore, returnSourceDocuments: boolean, modelTemperature: number, openAIapiKey: string) => {
