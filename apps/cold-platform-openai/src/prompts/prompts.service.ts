...
export class PromptsService extends BaseWorker {
  ...
  private async subscribeToFlagUpdates() {
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-yes-no-component-prompt updated`, value);
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-multi-select-component-prompt updated`, value);
    ...
    await this.darkly.subscribeToStringFlagChanges(
      'dynamic-text-component-prompt',
      value => {
        this.logger.info(`dynamic-text-component-prompt updated`, value);
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-text-area-component-prompt updated`, value);
        this.text_area_prompt = value;
      },
      {
        kind: 'model-compliance-set',
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-multi-text-component-prompt updated`, value);
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-select-component-prompt updated`, value);
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-percent-slider-component-prompt updated`, value);
    ...
    await this.darkly.subscribeToStringFlagChanges(
      ...
      value => {
        this.logger.info(`dynamic-number-component-prompt`, value);
