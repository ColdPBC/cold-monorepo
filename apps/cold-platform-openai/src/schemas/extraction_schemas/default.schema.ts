...
export const defaultExtractionSchema = z.object({
	...
	certificate_details: defaultCertificateSchema.describe(
		'If the document type is "CERTIFICATE", "SCOPE_CERTIFICATE" or "TRANSACTION_CERTIFICATE" then use this schema to extract the details, otherwise leave blank',
	),
