import { Collection, Entity, Enum, ManyToOne, OneToMany, OneToOne, PrimaryKey, Property, Ref, Unique } from '@mikro-orm/core';
...
export class OrganizationFile {
	...
	@OneToOne({ entity: () => Organization, ref: true, unique: 'organization_files_organization_id_id_key' })
