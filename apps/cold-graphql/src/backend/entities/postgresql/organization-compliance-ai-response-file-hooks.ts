// organization-compliance-ai-response-file-hooks.ts Sidecar - Entity hooks for organization
	import { CreateOrUpdateHookParams, ReadHookParams, DeleteHookParams } from '@exogee/graphweaver';

	import { OrgContext } from '../../acl_policies';
	import { ConsoleLogger } from '@nestjs/common';
	const logger = new ConsoleLogger('organization-compliance-ai-response-file-hooks')
