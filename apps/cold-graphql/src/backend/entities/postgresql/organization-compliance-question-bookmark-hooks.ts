// organization-compliance-question-bookmark-hooks.ts Sidecar - Entity hooks for organization
	import { CreateOrUpdateHookParams, ReadHookParams, DeleteHookParams } from '@exogee/graphweaver';

	import { OrgContext } from '../../acl_policies';
	import { ConsoleLogger } from '@nestjs/common';
	const logger = new ConsoleLogger('organization-compliance-question-bookmark-hooks')
