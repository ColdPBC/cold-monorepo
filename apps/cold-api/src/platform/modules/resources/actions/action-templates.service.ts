...
import { v4 } from 'uuid';
import { ActionTemplateSchema, ActionTemplatesEntity, BaseWorker, IRequest, MqttService, PrismaService, ZodCreateActionTemplate, ZodCreateActionTemplateDto } from '@coldpbc/nest';

@Span()
@Injectable()
export class ActionTemplatesService extends BaseWorker {
	constructor(private readonly prisma: PrismaService, private readonly mqtt: MqttService /* private readonly cacheService: CacheService, */) {
