...
import { BaseWorker, CreateActionTemplatesDto, IRequest, MqttService, PrismaService, ZodCreateActionDto } from '@coldpbc/nest';
import { SurveysService } from '../surveys/surveys.service';

@Span()
@Injectable()
export class ActionsService extends BaseWorker {
	constructor(readonly prisma: PrismaService, readonly surveys: SurveysService, readonly mqtt: MqttService /*readonly cacheService: CacheService,*/) {
