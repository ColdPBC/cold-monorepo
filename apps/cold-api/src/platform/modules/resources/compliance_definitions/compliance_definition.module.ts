...
import { CacheService, ColdCacheModule, ColdRabbitModule, ColdRabbitService, JwtStrategy, PrismaModule } from '@coldpbc/nest';
...
@Module({
  ...
  providers: [ComplianceDefinitionService, JwtService, JwtStrategy, CacheService, ColdRabbitService],
