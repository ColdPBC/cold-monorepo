    ...
    GHG: {
      ...
      follow_up: {
        ...
        'GHG-6A': {
          ...
          dependency: {
            expression:
              '["Yes, we calculate the carbon emissions from a subset of the products we sell, including those we sell to REI."] = $lookup(sections.*.follow_up, "GHG-6").value',
          },
          additional_context: {
    ...
    APK: {
      ...
      follow_up: {
        ...
        'APK-3': {
          ...
          dependency: {
            expression: '$lookup(sections.*.follow_up, "APK-1").value < 100',
          },
          options: [],
          tooltip: '',
          component: 'yes_no',
        ...
        'APK-7': {
          idx: 2,
          dependency: {
            expression: '$lookup(sections.*.follow_up, "APK-1").value > 0 and $lookup(sections.*.follow_up, "APK-2").value > 0',
          },
          prompt:
        ...
        'APK-8': {
          idx: 2,
          dependency: {
            expression: '$lookup(sections.$section.follow_up, "APK-1").value > 0 or $lookup(sections.$section.follow_up, "APK-2").value < 100',
          },
          prompt:
            'Of the total number of polybags used to ship apparel products to REI during the last calendar year, please indicate approximately what percentage are made of each of the following materials:',
          options: [],
