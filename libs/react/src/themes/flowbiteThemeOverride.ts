...
export const flowbiteThemeOverride: FlowbiteTheme = {
    ...
    rating: {
        ...
        advanced: {
            base: 'flex items-center',
            label: 'text-sm font-medium text-cold-skyBlue-600 dark:text-cold-skyBlue-500',
            progress: {
    ...
    sidebar: {
        root: {
            ...
            inner: 'h-[calc(100vh-80px)] w-52 py-6 flex flex-col gap-6 bg-bgc-elevated rounded-2xl border-2 border-gray-30 fixed overflow-y-auto overflow-x-visible scrollbar-hide',
        },
        collapse: {
            button:
