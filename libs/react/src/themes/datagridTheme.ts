...
export const DatagridTheme: FlowbiteTableTheme = {
	root: {
		base: 'w-full text-left text-sm text-gray-500 dark:text-gray-400 border-1 border-cold-fadeAwayGray',
	...
	head: {
		base: 'group/head text-xs uppercase px-0 py-0s h-16',
		cell: {
