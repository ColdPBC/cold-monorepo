import { SurveyDataType } from '@coldpbc/interfaces';

export const getSurveyDataByName = (name: string): SurveyDataType => {
  switch (name) {
    default:
    case 'qaalib_test':
...
export const getTestingSurveyData = (): SurveyDataType => {
  return {
