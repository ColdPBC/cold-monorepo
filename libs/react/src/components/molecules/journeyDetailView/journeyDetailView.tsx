...
export const JourneyDetailView = () => {
    ...
    const showLeadershipSection = data?.categories['climate_leadership']?.subcategories['management'] ||
        data?.categories['climate_leadership']?.subcategories['community_impact'];
