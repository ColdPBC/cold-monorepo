...
export const AttributeAssuranceGraph: React.FC<AttributeAssuranceGraphProps> = ({ entity, activeCount, expiredCount, notDocumentedCount }) => {
	...
	return (
		<>
			<div className="flex justify-between items-baseline">
				<p className={`text-sm ${total > 0 ? 'text-white' : 'text-tc-disabled'}`}>{pluralize(EntityLevel[entity], total)}</p>
				{total > 0 && (
