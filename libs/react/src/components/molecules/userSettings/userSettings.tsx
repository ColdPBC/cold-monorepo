    ...
    >
      ...
      <div className="flex w-full">
        <div className="flex justify-center items-center w-[400px] mr-10">
          {picture ? (
            <img
              className="w-[120px] h-auto rounded-2xl"
              src={picture}
              alt="profile"
            />
          ) : (
            ...
            >
              <path
                d="M0 16C0 7.16344 7.16345 0 16 0H104C112.837 0 120 7.16345 120 16V104C120 112.837 112.837 120 104 120H16C7.16344 120 0 112.837 0 104V16Z"
                fill="#282C3E"
              />
              <path
          ...
          <div className="flex flex-1 flex-col mb-11">
            ...
            <div className="flex">
              ...
              <div className="h-[60px] ml-2 flex items-center">
                <BaseButton
                  label="Edit"
                  onClick={() => setShowFirstNameModal(true)}
                  variant={ButtonTypes.secondary}
                />
              </div>
            </div>
          ...
          <div className="flex flex-col mb-5">
            ...
            <div className="flex">
              ...
              <div className="h-[60px] ml-2 flex items-center">
                <BaseButton
                  label="Edit"
                  onClick={() => setShowLastNameModal(true)}
                  variant={ButtonTypes.secondary}
                />
              </div>
            </div>
