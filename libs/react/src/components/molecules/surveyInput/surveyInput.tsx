...
export const SurveyInput = (props: SurveyInputProps) => {
                ...
                return (
                    <Input
                        ...
                        input_props={{
                            ...
                            onChange: (e) => onFieldUpdated(input_key, e.target.value),
                            onValueChange: (value) => {
                                onFieldUpdated(input_key, value);
                            },
                            className: "text-sm not-italic text-tc-primary font-medium bg-transparent w-full rounded-lg py-6 px-4 border border-bgc-accent focus:border focus:border-bgc-accent focus:ring-0",
                    ...
                    <div className={"flex h-[72px] w-full space-between border border-bgc-accent rounded-lg"}>
                        <div className={"h-[72px] w-[56px] py-6 px-4 align-content-center"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M16 9.00021C16 7 15 6 12 6M12 6C9 6 8 7 8 9C8 11 9 12 12 12C15 12 16 13 16 15C16 17 14 18 12 18M12 6V4M12 18C10 18 8 17 8 15M12 18V20" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
                            </svg>
                        </div>
                        <Input
                            ...
                            numeric_input_props={{
                                ...
                                onValueChange: (values) => {
                                    onFieldUpdated(input_key, values.formattedValue);
                                },
                                placeholder: placeholder,
                                title: tooltip,
    ...
    return (
        <div className="grid grid-cols-1 content-center space-y-6">
            <div className="text-left text-2xl not-italic font-bold text-tc-primary">
                {prompt}
            </div>
            {
                tooltip &&
                <div className="text-left text-sm not-italic font-medium text-tc-primary">
                    {tooltip}
                </div>
            }
