    ...
    switch (component) {
      ...
      case 'currency':
        return (
          <div
            className={
              'flex h-[72px] w-full space-between border border-bgc-accent rounded-lg'
            }
          >
            ...
            <Input
              ...
              numeric_input_props={{
                ...
                title: tooltip,
                className:
                  'text-sm not-italic text-tc-primary font-medium bg-transparent w-full h-full pl-0 pr-6 py-6 border-0 focus:border-0 focus:ring-0',
              }}
              container_classname={'w-full'}
            />
          </div>
