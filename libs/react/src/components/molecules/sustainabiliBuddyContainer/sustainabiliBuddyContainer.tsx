...
export const SustainabiliBuddyContainer = () => {
  ...
  return (
    <div className="h-[calc(100vh-170px)] md:h-[75vh] lg:h-[66.67vh] min-h-[400px] w-screen md:w-[66.67vw] lg:w-[50vw] p-0.5 rounded-[16px] bg-gradient-to-br from-[#F7FF58] via-lightblue-400 to-primary-300">
