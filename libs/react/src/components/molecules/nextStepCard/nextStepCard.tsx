...
import { SurveyNextStep } from '@coldpbc/interfaces';
...
export const NextStepCard = (props: NextStepCardProps) => {
  ...
  return (
    <div
      className={'w-full border-[1px] justify-start items-center space-y-[12px] border-bgc-accent rounded-2xl p-4 self-stretch bg-bgc-elevated text-tc-primary relative overflow-hidden'}
          ...
          >
            <div className={'flex w-full justify-center items-center space-x-2'}>
              <div className={'h-2 flex-1 w-full rounded-2xl bg-bgc-accent'}>
                <div className={'h-full rounded-2xl bg-primary'} style={{
                  width: `${nextStep.surveyProgress}%`
                }}>
                </div>
              </div>
              <div className={'flex text-body font-bold space-x-1'}>
                <div>{nextStep.surveyProgress}%</div>
                <div>Complete</div>
              </div>
            </div>
          </Card>
