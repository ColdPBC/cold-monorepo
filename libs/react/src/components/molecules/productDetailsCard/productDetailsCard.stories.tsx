...
export const Default: Story = {
  args: {
    product: {
      ...
      description: 'The Helium Rain Jacket is an ultra-packable, lightweight, breathable, multi-use award winner, offering durable weather protection when the forecast calls for on-and-off-again sun, showers, clouds, and cool breezes.',
