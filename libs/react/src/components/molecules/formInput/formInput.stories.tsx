...
const FormInputStory = (props: FormInputProps) => {
	const { onFieldUpdated, name, idx, input_label, type, placeholder, options, default_value, input_classname, label_classname, container_classname, auto_complete, value } = props;
