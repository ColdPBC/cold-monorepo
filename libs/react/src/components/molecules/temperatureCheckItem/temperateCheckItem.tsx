...
export const TemperatureCheckItem = ({
    icon,
    title,
    value,
    unitLabel,
    ...
    return (
        <div className="relative z-0 overflow-hidden rounded-lg">
            ...
            >
                <div 
                    className={clsx(
                        "shrink-0 rounded-[200px] bg-gradient-to-l from-primary via-primary via-[36.46%] to-bgc-accent",
                        {
            ...
            <div className="z-[2] bg-bgc-elevated h-[calc(100%-2px)] m-[1px] rounded-lg p-4 text-white flex flex-col items-center">
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex items-end">
                        <span className={clsx("font-bold text-xl leading-none", {"mr-1": unitLabel})}>
                            {value !== null ? value : '-'}
                        </span>
