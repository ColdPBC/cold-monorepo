...
export const SurveySectionsProgressBar = ({
  ...
  const getProgressBar = () => {
    const sectionLocationsSorted = orderBy(
      sectionLocations,
      ['sectionIndex'],
      ['asc'],
    );
    ...
    return (
      <div className={'relative w-[16px] z-10 px-[4px]'}>
        {sectionLocationsSorted.map((sectionLocation, index) => {
          ...
          if (
            index === sectionLocationsSorted.length - 1 &&
            index === activeIndex
          ) {
            ...
            if (activeIndex === index) {
              ...
              return (
                <div
                  ...
                  className={
                    'absolute w-[8px] bg-bgc-accent px-[2px] z-10 rounded-b'
                  }
                  style={{
                ...
                >
                  ...
                  >
                    {getProgressBarColorGradientSection(
                      sectionLocation.key,
                      index,
                    )}
                  </div>
