...
export function Card(props: PropsWithChildren<CardProps>) {
    ...
    return (
        <div className='flex flex-col p-4 items-start gap-6 self-stretch bg-bgc-elevated rounded-2xl text-tc-primary relative overflow-hidden'>
            {
                glow &&
            ...
            }
            {
                ...
                <div className='flex justify-end items-center gap-2 self-stretch'>
                    ...
                    }
                    {
                        ...
                        props.ctas?.map((cta) => {
                            return (cta.text && cta.action !== undefined && <BaseButton label={cta.text} onClick={cta.action} variant={cta.variant || ButtonTypes.secondary} />);
                        })
                    }
                </div>
            }
