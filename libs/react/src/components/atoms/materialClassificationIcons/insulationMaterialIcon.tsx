...
export const InsulationMaterialIcon = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<path d="M2.66662 14.9999L2.6665 0.716579" stroke={props.color || "black"} stroke-width="1.06667" stroke-linecap="round" />
			<path d="M13.4666 15.5007L13.4667 1.00018" stroke={props.color || "black"} stroke-width="1.06667" stroke-linecap="round" />
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
