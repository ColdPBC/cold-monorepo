...
const getColumnRows = (
	...
	return products.map(product => {
		...
		const allAttributeAssurances: SustainabilityAttributeAssurance[] = [...product.attributeAssurances, ...extraAttributes];
...
export const _ProductsDataGrid = () => {
	...
	const renderName = (params: any) => {
		...
		const text = [category, subcategory].filter((i: string) => i !== '').join(' | ');
