...
export const DataGridCellPillPopover = (props: { text: string; color?: string; width?: number }) => {
	...
	if (!isTruncated) {
		...
		return (
			<Popover content={text} contentClassName="w-[275px] max-h-[200px] overflow-y-scroll">
				<div
					className={'rounded-[32px] border-[1px] px-[16px] py-[4px] whitespace-nowrap truncate w-auto'}
					style={{
						borderColor: color,
