...
const _SustainabilityPage = () => {
	...
	if (error) {
		...
		return <ErrorPage error={error} showLogout={false} />;
	}

	const sustainabilityAttributes: SustainabilityAttribute[] = get(sustainabilityAttributesQuery.data, 'data.sustainabilityAttributes', []).sort((a, b) =>
