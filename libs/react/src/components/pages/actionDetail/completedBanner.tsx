    ...
    <div className="flex flex-col justify-center bg-primary-300 px-4 h-[120px] relative rounded-2xl text-white overflow-hidden">
      ...
      >
        ...
        <rect
          ...
          height="19.448"
          rx="3.88959"
          transform="rotate(60.9887 609.188 58.625)"
          fill="#E1E2EB"
        />
        <rect
          x="807.285"
          ...
          height="19.448"
          rx="3.88959"
          transform="rotate(60.9887 807.285 63.8828)"
          fill="#E1E2EB"
        />
        <rect
          x="726.846"
          ...
          height="19.448"
          rx="3.88959"
          transform="rotate(29.4959 726.846 12.3438)"
          fill="#C79EEF"
        />
        <rect
          x="755.611"
          ...
          height="35.9964"
          rx="7.19928"
          transform="rotate(135.565 755.611 102.738)"
          fill="#66FFA9"
        />
        <rect
          x="587.832"
          ...
          height="35.9964"
          rx="7.19928"
          transform="rotate(135.565 587.832 24.7031)"
          fill="#E1E2EB"
        />
        <rect
          x="729.461"
          ...
          height="35.9964"
          rx="7.19928"
          transform="rotate(105.398 729.461 48.4453)"
          fill="#66FFA9"
        />
        <rect
          x="876.529"
          ...
          height="21.62"
          rx="7.77918"
          transform="rotate(121.925 876.529 39.3359)"
          fill="#66FFA9"
        />
        <rect
          x="901.652"
          ...
          height="21.62"
          rx="7.77918"
          transform="rotate(-129.684 901.652 136.195)"
          fill="#E1E2EB"
        />
        <rect
          x="773.838"
          ...
          height="19.448"
          rx="3.88959"
          transform="rotate(-16.9392 773.838 20.9297)"
          fill="#C79EEF"
        />
        <rect
          x="774.059"
          ...
          height="15.6371"
          rx="3.88959"
          transform="rotate(-56.2386 774.059 115.613)"
          fill="#66C8FF"
        />
        <rect
          x="847.959"
          ...
          height="15.6371"
          rx="3.88959"
          transform="rotate(-56.2386 847.959 96.168)"
          fill="#66FFA9"
        />
        <path
