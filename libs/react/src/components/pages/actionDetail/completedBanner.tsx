export const CompletedBanner = () => {
    return (
        <div className="flex flex-col justify-center bg-primary-300 px-4 h-[120px] relative rounded-2xl text-white overflow-hidden">
            <div
                className="w-[857px] h-[845px] absolute left-[-67px] bottom-[-363px] bg-primary-200 blur-[150px] z-10"
            />
            <div className="z-20">
                <div className="font-bold text-xl leading-normal mb-2">Keep it up!</div>
                <div className="font-medium leading-normal text-sm">You are doing everything you can to reduce your carbon footprint in this area.</div>
            </div>
            <svg className="absolute right-[0]" width="899" height="120" viewBox="0 0 899 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M619.098 19.8742L624.815 19.8757C635.481 19.8784 643.372 29.8036 640.971 40.1965V40.1965C638.908 49.1218 644.472 58.0291 653.397 60.0915L655.475 60.5716C665.547 62.8991 671.826 72.9514 669.498 83.024V83.024C667.171 93.0966 673.449 103.149 683.522 105.476L685.602 105.957C694.526 108.019 700.088 116.925 698.026 125.849V125.849C695.625 136.242 703.518 146.167 714.185 146.167L728.008 146.167" stroke="#66C8FF" stroke-width="7.77918" stroke-linecap="round"/>
                <path d="M549.775 58.7703L561.178 58.7703C567.475 58.7703 572.581 63.8756 572.581 70.1733V70.1733C572.581 76.4711 577.686 81.5764 583.984 81.5764V81.5764C590.282 81.5764 595.387 86.6817 595.387 92.9795V92.9795C595.387 99.2772 600.492 104.383 606.79 104.383L618.193 104.383" stroke="#C79EEF" stroke-width="7.77918" stroke-linecap="round"/>
                <path d="M869.5 -14.9809L868.935 -3.59176C868.623 2.69827 863.272 7.54464 856.982 7.23292V7.23292C850.692 6.9212 845.34 11.7676 845.028 18.0576V18.0576C844.716 24.3476 839.365 29.194 833.075 28.8823V28.8823C826.785 28.5706 821.433 33.4169 821.121 39.707L820.557 51.0961" stroke="#99A2E6" stroke-width="7.77918" stroke-linecap="round"/>
            </svg>
        </div>
    );
}