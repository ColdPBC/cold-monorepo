...
import {RegulationCategory, RegulationStatus, RegulationSubcategory} from "@coldpbc/enums";
...
export const RegulatoryCompliance = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { ...DEFAULT_GRID_COL_DEF, field: 'Penalties (Beyond Fees)', headerName: 'Penalties (Beyond Fees)', width: 200 },
  ]
