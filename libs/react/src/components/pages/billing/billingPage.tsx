...
const _BillingPage = () => {
	...
	logBrowser('Billing Page', 'info', {
		subscriptionSWR: subscriptionSWR.data,
		productsSWR: productsSWR.data,
		paymentUpdatePortalSessionSWR: paymentUpdatePortalSessionSWR.data,
	});
