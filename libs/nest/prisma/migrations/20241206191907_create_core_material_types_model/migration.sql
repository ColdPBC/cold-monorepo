-- CreateTable
CREATE TABLE "core_material_types" (
    "name" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "core_material_types_name_key" ON "core_material_types"("name");

-- Insert Data
INSERT INTO core_material_types (name, category, created_at, updated_at)
